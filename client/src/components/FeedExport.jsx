...
export default function FeedExport({ feedName, itemCount, categories, marketplace, onDownload, onSaveConfig, onBack }) {
      ...
      <Card className="mb-6">
        <CardContent className="pt-6">
          ...
          <div className="mb-6">
            ...
            <RadioGroup value={exportOption} onValueChange={setExportOption} className="space-y-3">
          ...
          <div className="mb-6">
            ...
            <div className="bg-muted/20 p-4 rounded-lg">
              <div className="flex items-start mb-3">
                <Checkbox id="scheduleUpdates" checked={scheduleEnabled} onCheckedChange={(checked) => setScheduleEnabled(checked === true)} className="mt-1 mr-3"/>
                <div>
              ...
              {scheduleEnabled && (<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between space-y-3 sm:space-y-0 sm:space-x-3">
            ...
            <div className="flex space-x-3">
              <Button variant="outline" className="border-primary text-primary hover:bg-primary/10" onClick={onSaveConfig}>
