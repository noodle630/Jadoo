      ...
      <header className="bg-slate-100/50 dark:bg-slate-950/50 backdrop-blur-md py-2 px-4 border-b border-slate-200 dark:border-slate-800/50 flex items-center h-16">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" size="icon" className="mr-2 bg-slate-800/10 dark:bg-slate-800/40 border-slate-300/50 dark:border-slate-700/50 hover:bg-slate-800/20 dark:hover:bg-slate-700/50">
