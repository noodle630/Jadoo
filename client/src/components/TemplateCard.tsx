...
export default function TemplateCard({
  ...
  if (isAddCard) {
    return (
      <Card 
        className="border-dashed hover:border-primary transition-all duration-300 cursor-pointer bg-muted/20 flex flex-col items-center justify-center p-10 hover:bg-muted/10 hover:scale-[1.02]"
        onClick={onAdd}
      >
  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-[1.02] border-t-2">
      ...
      <CardFooter className="p-4 border-t bg-gradient-to-r from-slate-50 to-white flex justify-between items-center">
        ...
        <Button 
          className="flex-1 ml-2 bg-gradient-to-r from-slate-800 to-slate-700 hover:from-slate-700 hover:to-slate-600 shadow-md" 
