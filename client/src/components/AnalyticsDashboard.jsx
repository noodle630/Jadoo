...
const AnalyticsDashboard = () => {
    ...
    const fetchAnalytics = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setLoading(true);
            const response = yield fetch('/api/analytics/dashboard');
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatDuration(data.jobSummary.reduce((sum, job) => sum + (job.avg_processing_time_ms || 0), 0) /
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatPercentage(data.jobSummary.reduce((sum, job) => sum + (job.avg_success_rate || 0), 0) /
            Math.max(data.jobSummary.length, 1))}
                </div>
              </CardContent>
            </Card>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {data.recentJobs.map((job) => (<TableRow key={job.feed_id}>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {data.jobSummary.map((job, index) => (<TableRow key={index}>
                      <TableCell>{job.platform}</TableCell>
                      <TableCell>{job.category || 'N/A'}</TableCell>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {data.fieldSummary.map((field, index) => (<TableRow key={index}>
        ...
        <TabsContent value="llm" className="space-y-4">
          <Card>
            ...
            return (<TableRow key={index}>
                      ...
                      <TableCell>${((_a = llm.total_cost) === null || _a === void 0 ? void 0 : _a.toFixed(4)) || '0.0000'}</TableCell>
                      <TableCell>
