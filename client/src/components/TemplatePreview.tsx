                  ...
                  <thead>
                    <tr className="bg-green-100">
                      {fields.slice(0, 10).map((field, i) => (
                        <th key={i} className="border border-gray-300 px-4 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                          {field.name}
                  ...
                  <tbody>
                    {samples.map((sample, rowIndex) => (
                      <tr key={rowIndex} className={rowIndex % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                        {fields.slice(0, 10).map((field, colIndex) => (
                          <td key={colIndex} className="border border-gray-300 px-4 py-2 text-sm text-gray-700 whitespace-nowrap overflow-hidden text-ellipsis" style={{maxWidth: '150px'}}>
                            {sample[field.name] || ''}
                          </td>
                        ))}
                      </tr>
