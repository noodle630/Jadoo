...
export function MarketplaceIcon({ 
  ...
  switch (marketplaceLower) {
    ...
    case "catch":
      return (
        <div 
          className={`flex items-center justify-center bg-[#2F3FFF] text-white rounded w-${iconSize === 14 ? '4' : iconSize === 18 ? '5' : iconSize === 24 ? '6' : '8'} h-${iconSize === 14 ? '4' : iconSize === 18 ? '5' : iconSize === 24 ? '6' : '8'} ${className}`}
    ...
    case "reebelo":
      return (
        <div 
          className={`flex items-center justify-center bg-[#00B67A] text-white rounded w-${iconSize === 14 ? '4' : iconSize === 18 ? '5' : iconSize === 24 ? '6' : '8'} h-${iconSize === 14 ? '4' : iconSize === 18 ? '5' : iconSize === 24 ? '6' : '8'} ${className}`}
          style={{ fontSize: iconSize * 0.6 }}
        >
          R
        </div>
