...
export function StatusBadge({ status, size = "md", withIcon = true, className }) {
    ...
    return (<div className={cn("inline-flex items-center font-medium rounded-full", bg, text, sizeClasses[size], className)}>
