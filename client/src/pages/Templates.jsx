...
import { MoreHorizontal, Loader2, AlertCircle, FileText, Plus, Star, Copy, Edit, Trash } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (<div className="flex justify-center items-center p-8">
            ...
            </div>) : templates && templates.length > 0 ? (<div className="rounded-md border">
              <Table>
                <TableHeader>
                  <TableRow>
        ...
        {templates && templates.length > 3 && (<CardFooter className="flex justify-center border-t p-4">
