    ...
    return (<AuthLayout>
      <Card className="bg-gray-900 border-gray-800 w-full max-w-md">
        ...
        <CardContent className="grid gap-4">
          {/* Google login button */}
          <Button variant="outline" className="w-full border-gray-700 text-white hover:bg-gray-800 flex items-center justify-center gap-2" onClick={handleGoogleLogin} disabled={isLoading}>
          ...
          {/* Replit login button */}
          <Button className="w-full bg-blue-600 hover:bg-blue-700" onClick={handleReplitLogin} disabled={isLoading}>
