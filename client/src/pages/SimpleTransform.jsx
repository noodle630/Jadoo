      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card>
            ...
            'border-slate-300 hover:border-slate-400 dark:border-slate-700 dark:hover:border-slate-600'}`} onClick={() => { var _a; return (_a = document.getElementById('file-input')) === null || _a === void 0 ? void 0 : _a.click(); }}>
                    <input type="file" id="file-input" accept=".csv" onChange={handleFileChange} className="hidden" disabled={isUploading}/>
        ...
        <div>
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {result && result.success && (<div className="mt-4 p-4 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-900">
                  <h3 className="text-base font-medium text-green-800 dark:text-green-400 mb-2">
                    Transformation Successful
                  </h3>
                  {result.input_rows && result.output_rows && (<p className="text-sm text-green-700 dark:text-green-300">
                      Transformed {result.input_rows} input rows to {result.output_rows} output rows
                    </p>)}
                  {result.filename && (<div className="flex items-center gap-2 mt-2">
