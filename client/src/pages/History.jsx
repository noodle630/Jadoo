...
import { Download, MoreHorizontal, Loader2, AlertCircle, CheckCircle, Clock, Ban, FileText } from "lucide-react";
...
export default function History() {
    ...
    const handleDownload = (feedId) => __awaiter(this, void 0, void 0, function* () {
        try {
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (<div className="flex justify-center items-center p-8">
            ...
            </div>) : error ? (<div className="flex justify-center items-center p-8 text-center">
              <div>
                <AlertCircle className="h-8 w-8 text-red-500 mx-auto mb-2"/>
                <p className="text-gray-400">Failed to load feed history</p>
              </div>
            </div>) : feeds && feeds.length > 0 ? (<div className="rounded-md border">
              <Table>
                <TableHeader>
                  <TableRow>
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => handleDownload(feed.id)} disabled={feed.status !== 'completed'}>
            ...
            </div>) : (<div className="flex justify-center items-center p-8 text-center">
              <div>
        ...
        {feeds && feeds.length > 0 && (<CardFooter className="flex justify-center border-t p-4">
