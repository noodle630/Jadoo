...
export default function NotFound() {
    ...
    return (<div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950 text-white flex flex-col items-center justify-center p-4">
      <div className="space-y-6 text-center max-w-lg">
        ...
        <Button className="mt-4 bg-blue-600 hover:bg-blue-700" onClick={() => navigate("/")}>
