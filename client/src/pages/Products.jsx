...
import { Filter, Plus, Search, RefreshCw, Download, Upload, PackageOpen, MoreVertical, X, ExternalLink } from "lucide-react";
...
export default function Products() {
                    ...
                    if (searchQuery) {
                        ...
                        filteredProducts = filteredProducts.filter(p => {
                            ...
                            return p.name.toLowerCase().includes(query) ||
                                ...
                                ((_a = p.brand) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(query)) ||
                                ((_b = p.category) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(query));
                        });
                    }
                    // Apply sorting
    ...
    const renderMarketplaces = (product) => {
        ...
        {marketplaces.map(marketplace => (<TooltipProvider key={marketplace}>
            <Tooltip>
        ...
        <CardContent className="p-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
            <div className="flex-1 relative w-full max-w-sm">
              ...
              <Input placeholder="Search products by name, SKU, brand..." className="pl-8" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}/>
            </div>
          ...
          <div className="border rounded-md overflow-hidden">
              ...
              <Table>
                <TableHeader className="bg-slate-50 dark:bg-slate-900">
                  <TableRow>
                    <TableHead className="w-[40px] text-center">
                      <Checkbox checked={products && products.length > 0 && selectedProducts.length === products.length} onCheckedChange={handleSelectAll}/>
                    </TableHead>
                    <TableHead className="cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800" onClick={() => handleSort('sku')}>
                    ...
                    <TableHead className="cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800" onClick={() => handleSort('price')}>
                      Price{renderSortIndicator('price')}
                    </TableHead>
                    <TableHead className="cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800" onClick={() => handleSort('quantity')}>
                ...
                <TableBody>
                  {isLoading ? (Array(5).fill(0).map((_, idx) => (<TableRow key={idx} className="animate-pulse">
                    ...
                    </TableRow>) : (products === null || products === void 0 ? void 0 : products.length) === 0 ? (<TableRow>
                      <TableCell colSpan={8} className="text-center py-8 text-muted-foreground">
                        No products found. Try adjusting your search or filters.
                      </TableCell>
                    </TableRow>) : (products === null || products === void 0 ? void 0 : products.map((product) => (<TableRow key={product.id} className="group">
                        ...
                        <TableCell>
                          <div className="flex items-center gap-3">
                            <div className="h-10 w-10 rounded bg-slate-100 flex items-center justify-center overflow-hidden">
                              {product.imageUrl ? (<img src={product.imageUrl} alt={product.name} className="h-full w-full object-cover" onError={(e) => {
                    e.target.src = 'https://placehold.co/40x40?text=No+Image';
                        ...
                        <TableCell>
                          <div className="flex flex-col">
                            ...
                            {product.salePrice && (<div className="flex items-center gap-1">
            ...
            <div className="p-2 flex items-center justify-between bg-slate-50 dark:bg-slate-900 border-t">
              <div className="text-sm text-muted-foreground">
                Showing <span className="font-medium">{(products === null || products === void 0 ? void 0 : products.length) || 0}</span> of{" "}
                <span className="font-medium">{(products === null || products === void 0 ? void 0 : products.length) || 0}</span> products
              </div>
              ...
              <Pagination>
                <PaginationContent>
                  ...
                  {Array.from({ length: Math.min(3, Math.max(1, (products === null || products === void 0 ? void 0 : products.length) || 0)) }).map((_, idx) => (<PaginationItem key={idx}>
