...
function transformWithExactMapping(inputPath, outputPath, transformFn = null) {
    ...
    try {
        ...
        return {
            ...
            headerInputColumns: ((_a = rowInfo.columns) === null || _a === void 0 ? void 0 : _a.length) || 0,
            headerOutputColumns: ((_b = outputRowInfo.columns) === null || _b === void 0 ? void 0 : _b.length) || 0
        };
    }
    catch (error) {
...
export { countExactRows, transformWithExactMapping };
