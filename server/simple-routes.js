...
export function createSimpleRoutes() {
    ...
    router.post('/simple-upload', upload.single('file'), (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    router.get('/simple-download/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
        try {
            // Get feed ID
